class CatalogController < ApplicationController
  ...
  before_action :enforce_show_permissions, only: :show # rubocop:disable Rails/LexicallyScopedActionFilter
  ...
  configure_blacklight do |config|
    ...
    config.add_show_field solr_name("loc_name", :stored_searchable), label: "LOC Name"
